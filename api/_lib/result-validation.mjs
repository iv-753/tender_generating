import { ZHUJIANG_TASKS } from '../../scripts/calculation/zhujiang-operations.mjs';
...
export function resultValidationError(result) {
  ...
  if (result.calculationModel === 'zhujiang-v1' && ['2026-09-22-operations','2026-09-23-reference-defaults','2026-09-23-source-boundary'].includes(result.standard?.revision)) for (const task of ZHUJIANG_TASKS) expectedIds.set(task.id,task.category);
